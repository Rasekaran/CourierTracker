...
<head>
    ...
    <meta name="author" content="MSc IT 2015 Batch">
	<META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW"> 
	<link rel="shortcut icon" type="image/png" href="images/delivery-box-icon.png" >
...
<div id="divBoxed" class="container">
    ...
    <div class="divPanel notop nobottom">
            <div class="row-fluid">
                <div class="span12">
					<a href="login.html" class="button" style="float:right;margin-top:10px;"><span class="icon-user"> Login</span></a>
                    <div id="divLogo" class="pull-left">
                        <a href="index.html" id="divSiteTitle">ABC Courier Service</a><br />
                        <a href="index.html" id="divTagLine">Keep in Touch With Your Courier</a>
            ...
            <div class="span12">
                ...
                <div class="camera_full_width">
                    <div id="camera_wrap">
                        <div data-src="slider-images/a.jpg" ></div>
						<div data-src="slider-images/b.jpg" ></div>
						<div data-src="slider-images/c.jpg" ></div>
                    </div>
