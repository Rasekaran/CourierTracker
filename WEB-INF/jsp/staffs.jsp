    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <div class="breadcrumbs">
                <a href="index.html">Home</a> &nbsp;/&nbsp; <span>Staffs</span>
            </div>
            ...
            <!--Edit Main Content Area here-->
                <div class="span12" id="divMain">
                    ...
                    <div class="modal-header">
                        ...
                        <h3 id="myModalLabel">Add New Staff</h3>
                    </div>
                    ...
                    <div class="modal-body">                       
						...
						<input type="text" class="form-control" placeholder="DOB" name="txtPCode" id="txtDOB">
						<input type="text" class="form-control" placeholder="Branch ID" name="txtPCode" id="txtBranchID">
						<input type="text" class="form-control" placeholder="Join Date" name="txtPCode" id="txtJoinDate">
						<input type="text" class="form-control" placeholder="Designation" name="txtPCode" id="txtDesignation">
                ...
                <a data-toggle="modal" href="#myModal" class="btn btn-primary btn-large">Add New Staff</a>			
					...
					<br><br>
					<h3>Staff Info</h3>
					<input type="text" class="form-control" placeholder="Postal Code" name="txtPCode" id="search-staff-id">
					<button class="btn" onclick="getStaffDetails()">Find</button>
...
function getStaffDetails(){
	...
	$.ajax({
	  method: "GET",
	  url: 'http://localhost:8080/couriertracking/staff/' + $("#search-staff-id").val(),
	  data: "",
	  dataType: 'json',
	...
	.done(function(data) {
		...
		var trHTML="";
		var no = 0;
		trHTML += '<tr><td>' + data.ssn + '</td><td>' + data.fName + '</td><td>' + data.lName + '</td><td>' + data.street + '</td><td>' + data.city + '</td><td>' + data.country + '</td><td>' + data.postalCode + '</td><td>' + data.id + '</td><td>' + new Date( data.dob ) + '</td><td>' + data.branchID + '</td><td>' + new Date( data.joinDate ) + '</td><td>' + data.designation + '</td></tr>';
...
function saveStaff(){
	...
	$.ajax({
	  method: "POST",
	  url: 'http://localhost:8080/couriertracking/staff/create',
	  data: JSON.stringify( staff ),
	  dataType: 'json',
	  contentType: "application/json; charset=utf-8",
	  success:function(data) {
         window.location.replace("http://localhost:8080/couriertracking/staffs");
      }
	})
	// .done(function(data) {
